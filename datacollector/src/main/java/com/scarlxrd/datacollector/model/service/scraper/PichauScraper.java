...
@Component
public class PichauScraper extends AbstractSeleniumScraper {

    /*
     * A Pichau atualmente apresenta:
     *
     * à vista
     * R$ 829.99
    ...
    private String capturePrice(
        ...
        /*
         * Último fallback:
         * qualquer preço encontrado na página.
         */
        return extractPrice(
                normalizedBody,
                PRICE_PATTERN);
    ...
    private void validatePage(
        ...
        if (currentUrl == null
            ...
            throw new CollectionException(
                    ...
                    Store.PICHAU,
                    url,
                    "Pichau retornou uma página sem URL válida");
        }
        ...
        if (antiBotByUrl
            ...
            throw new CollectionException(
                    ...
                    Store.PICHAU,
                    url,
                    "Pichau retornou uma página explícita "
        ...
        if (productNotFound) {
            throw new CollectionException(
                    ...
                    Store.PICHAU,
                    url,
                    "Produto da Pichau não encontrado");
        }
    }
